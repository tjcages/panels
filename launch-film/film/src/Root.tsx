...
import { LINES, PARTS, SCENES } from './film'
...
for (const cut of editFile.cuts as Cut[]) {
  if (cut.scene in LINES) {
    validateReadingHold(cut.scene, LINES[cut.scene as keyof typeof LINES], cut.out - cut.in)
  }
}
